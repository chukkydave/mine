				...
				owlslider.each(function() {
					var $this = $(this),
						$items =
							...
							1,
						$loop =
							$this.attr('data-loop') ? $this.data('loop') :
							true,
						$navdots =
							$this.data('nav-dots') ? $this.data('nav-dots') :
							false,
						$navarrow =
							$this.data('nav-arrow') ? $this.data('nav-arrow') :
							false,
						$autoplay =
							$this.attr('data-autoplay') ? $this.data('autoplay') :
							true,
						$autospeed =
							$this.attr('data-autospeed') ? $this.data('autospeed') :
							5000,
						$smartspeed =
							$this.attr('data-smartspeed') ? $this.data('smartspeed') :
							1000,
						$autohgt =
							$this.data('autoheight') ? $this.data('autoheight') :
							false,
						$CenterSlider =
							$this.data('center') ? $this.data('center') :
							false,
						$space =
							$this.attr('data-space') ? $this.data('space') :
							30;
					...
					$(this).owlCarousel({
						...
						responsive: {
							0: {
								items:
									$this.data('xx-items') ? $this.data('xx-items') :
									1,
							},
							480: {
								items:
									$this.data('xs-items') ? $this.data('xs-items') :
									1,
							},
							768: {
								items:
									$this.data('sm-items') ? $this.data('sm-items') :
									1,
							},
							980: {
								items:
									$this.data('md-items') ? $this.data('md-items') :
									1,
							},
							1200: { items: $items },
						},
					...
					$('.lightbox-gallery').magnificPopup({
						...
						gallery: {
							...
							preload: [
								0,
								1,
							], // Will preload 0 - before current, and 1 after NAY current image
						},
					});
				}
