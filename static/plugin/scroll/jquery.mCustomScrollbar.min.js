	...
	!(function(t) {
		...
		var t,
			...
			s =
					...
					window.attachEvent && !window.addEventListener ? 1 :
					0,
			c = !1,
			d = [
				'mCSB_dragger_onDrag',
			...
			u = {
				init: function(t) {
					...
					return (
						(t.setWidth =
							t.set_width ? t.set_width :
							t.setWidth),
						(t.setHeight =
							t.set_height ? t.set_height :
							t.setHeight),
						(t.axis =
							t.horizontalScroll ? 'x' :
							p(t.axis)),
						(t.scrollInertia =

								t.scrollInertia > 0 && t.scrollInertia < 17 ? 17 :
								t.scrollInertia),
						...
						(t.mouseWheel.normalizeDelta =
							t.advanced.normalizeMouseWheelDelta ? t.advanced
				...
				update: function(t, o) {
					...
					return e(n).each(function() {
						...
						if (t.data(a)) {
							...
							'x' !== i.axis &&
								(
									n.overflowed[0] ? s[0].height() >
									s[0].parent().height() ? B.call(this) :
									(G(t, c[0].toString(), { dir: 'y', dur: 0, overwrite: 'none' }),
									(n.contentReset.y = null)) :
									(B.call(this),

										'y' === i.axis ? k.call(this) :
										'yx' === i.axis &&
										n.overflowed[1] &&
										G(t, c[1].toString(), {
											dir: 'x',
								...
								'y' !== i.axis &&
									(
										n.overflowed[1] ? s[1].width() >
										s[1].parent().width() ? B.call(this) :
										(G(t, c[1].toString(), {
											dir: 'x',
											dur: 0,
											overwrite: 'none',
								...
								o &&
									...
									(
										...
										'function' ==
											typeof i.callbacks
												.onSelectorChange ? i.callbacks.onSelectorChange.call(
											this,
										) :
							...
							if (n.data(a)) {
								var i = n.data(a),
									...
									d =
											...
											s.scrollInertia > 0 && s.scrollInertia < 17 ? 17 :
											s.scrollInertia;
			...
			f = function() {
				return
					'object' != typeof e(this) || e(this).length < 1 ? n :
					this;
			},
			h = function(t) {
				var o = [
				...
				(t.autoDraggerLength =
						...
						e.inArray(t.theme, o) > -1 ? !1 :
						t.autoDraggerLength),
					(t.autoExpandScrollbar =

							e.inArray(t.theme, a) > -1 ? !1 :
							t.autoExpandScrollbar),
					(t.scrollButtons.enable =

							e.inArray(t.theme, n) > -1 ? !1 :
							t.scrollButtons.enable),
					(t.autoHideScrollbar =

							e.inArray(t.theme, i) > -1 ? !0 :
							t.autoHideScrollbar),
					(t.scrollbarPosition =

							e.inArray(t.theme, r) > -1 ? 'outside' :
							t.scrollbarPosition);
			},
			m = function(e) {
			...
			g = function(e) {
				return
					'stepped' === e || 'pixels' === e || 'step' === e || 'click' === e ? 'stepped' :
					'stepless';
			},
			v = function() {
				var t = e(this),
					...
					i = n.opt,
					r =
						i.autoExpandScrollbar ? ' ' + d[1] + '_expand' :
						'',
					l = [
						"<div id='mCSB_" +
							n.idx +
					...
					s =
							...
							'yx' === i.axis ? 'mCSB_vertical_horizontal' :
							'x' === i.axis ? 'mCSB_horizontal' :
							'mCSB_vertical',
					c =
					...
					u =
							...
							'yx' === i.axis ? "<div id='mCSB_" +
							n.idx +
							"_container_wrapper' class='mCSB_container_wrapper' />" :
							'',
					f =
						i.autoHideScrollbar ? ' ' + d[6] :
						'',
					h =

							'x' !== i.axis && 'rtl' === n.langDir ? ' ' + d[7] :
							'';
				i.setWidth && t.css('width', i.setWidth),
					i.setHeight && t.css('height', i.setHeight),
					(i.setLeft =

							'y' !== i.axis && 'rtl' === n.langDir ? '989999px' :
							i.setLeft),
					t
				...
				'y' === i.axis || i.advanced.autoExpandHorizontalScroll || p.css('width', x(p)),
						...
						'outside' === i.scrollbarPosition ? ('static' === t.css('position') &&
			...
			w = function() {
				var t = e(this),
					...
					r =
						oe(n.scrollButtons.tabindex) ? "tabindex='" +
			...
			y = function() {
				var t = e(this),
					...
					r =
							...
							null == o.overflowed ? i.height() :
							i.outerHeight(!1),
					l =

							null == o.overflowed ? i.width() :
							i.outerWidth(!1),
					s = i[0].scrollHeight,
					c = i[0].scrollWidth;
				return (
			...
			T = function() {
				function t() {
					r = setTimeout(function() {
							...
							e.event.special.mousewheel ? (clearTimeout(r), W.call(o[0])) :
							t();
					}, 100);
				}
				var o = e(this),
			...
			k = function() {
				...
				n.advanced.releaseDraggableSelectors &&
					...
					o.bindEvents &&
						(e(document).add(e(!A() || top.document)).unbind('.' + i),
						l.each(function() {
							e(this).unbind('.' + i);
						}),
			...
			M = function(t) {
				...
				'x' !== i.axis &&
					(
						n.overflowed[0] && !t ? (s[0]
							.add(c[0])
							.add(s[0].children('a'))
							.css('display', 'block'),
						l.removeClass(d[8] + ' ' + d[10])) :
						(
							i.alwaysShowScrollbar ? (2 !== i.alwaysShowScrollbar &&
					...
					'y' !== i.axis &&
						...
						n.overflowed[0] || n.overflowed[1] ? o.removeClass(d[5]) :
						o.addClass(d[5]);
			},
			O = function(t) {
				var o = t.type,
			...
			I = function() {
				...
				var o,
					...
					m = e('#' + f[0] + ',#' + f[1]),
					p =
						d.advanced.releaseDraggableSelectors ? m.add(
							e(d.advanced.releaseDraggableSelectors),
						) :
						m,
					g =
						d.advanced.extraDraggableSelectors ? e(!A() || top.document).add(
			...
			E = function() {
				function o() {
					return
						...
						document.selection &&
						'Control' != document.selection.type ? document.selection.createRange()
							.text :
						0;
				}
				function n(e, t, o) {
					...
					.bind('mousemove.' + u, function(e) {
						if (!t && i && o()) {
							var a = f.offset(),
								...
								r > 0 && r < h.height() && c > 0 && c < h.width() ? d.step &&
								n('off', null, 'stepped') :
								('x' !== s.axis &&
									l.overflowed[0] &&
									(
				...
				function t(t, a) {
					if ((Q(o), !z(o, t.target))) {
						var r =
									...
									'auto' !== i.mouseWheel.deltaFactor ? parseInt(
										i.mouseWheel.deltaFactor,
									) :
									s && t.deltaFactor < 100 ? 100 :
									t.deltaFactor || 100,
							d = i.scrollInertia;
						if ('x' === i.axis || 'x' === i.mouseWheel.axis)
							var u = 'x',
								...
								h =
										...
										'auto' !== i.mouseWheel.scrollAmount ? f[1] :
										f[0] >= l.width() ? 0.9 * l.width() :
										f[0],
								...
								v =
										...
										'y' === i.mouseWheel.axis ? t.deltaY || a :
										t.deltaX;
						else
							var u = 'y',
								f = [
								...
								if (
									...
									var h = 'x',
										m =
												...
												35 === l ? Math.abs(d.width() - c.outerWidth(!1)) :
												0;
								else
									var h = 'y',
										m =
			...
			j = function(t, o, n, i, r) {
				function l(e) {
					u.snapAmount &&
						(f.scrollAmount =
								...
								u.snapAmount instanceof Array ? 'x' === f.dir[0] ? u.snapAmount[1] :
								u.snapAmount[0] :
								u.snapAmount);
					var o = 'stepped' !== f.type,
						...
						d = [
								...
								c.scrollRatio.y > 10 ? 10 :
								c.scrollRatio.y,

								c.scrollRatio.x > 10 ? 10 :
								c.scrollRatio.x,
						],
						m =

								'x' === f.dir[0] ? s[1] + f.dir[1] * (d[1] * n) :
								s[0] + f.dir[1] * (d[0] * n),
						v =

								'x' === f.dir[0] ? s[1] + f.dir[1] * parseInt(f.scrollAmount) :
								s[0] + f.dir[1] * parseInt(f.scrollAmount),
						x =

								'auto' !== f.scrollAmount ? v :
								m,
						_ =
							i ? i :
							e ? o ? 'mcsLinearOut' :
				...
				var c = t.data(a),
					...
					p =
							...
							u.scrollInertia < 26 ? 26 :
							u.scrollInertia,
					g =

							u.scrollInertia < 1 ? 17 :
							u.scrollInertia;
				switch (o) {
					case 'on':
						if (
							((f.dir = [
									...
									n === d[16] || n === d[15] || 39 === n || 37 === n ? 'x' :
									'y',

									n === d[13] || n === d[15] || 38 === n || 37 === n ? -1 :
									1,
							]),
							Q(t),
							oe(n) && 'stepped' === f.type)
			...
			N = function(t) {
				function o() {
					return (
						clearTimeout(f[0].autoUpdate),
							...
							0 === l.parents('html').length ? void (l = null) :
							void (f[0].autoUpdate = setTimeout(function() {
								return
									c.advanced.updateOnSelectorChange &&
									((s.poll.change.n = i()),
									s.poll.change.n !== s.poll.change.o) ? ((s.poll.change.o =
										s.poll.change.n),
									void r(3)) :
				...
				return
					t ? (clearTimeout(f[0].autoUpdate), void $(f[0], 'autoUpdate')) :
					void o();
			},
			V = function(e, t, o) {
			...
			G = function(t, o, n) {
				...
				var s = t.data(a),
					...
					m = h.parent(),
					p =
						c.callbacks.onTotalScrollOffset ? Y.call(
							t,
							c.callbacks.onTotalScrollOffset,
						) :
						[
							0,
							0,
					...
					g =
						c.callbacks.onTotalScrollBackOffset ? Y.call(
							t,
				...
				if (
					...
					if (
						...
						var v =
								...
								c.snapAmount instanceof Array ? 'x' === n.dir ? c.snapAmount[1] :
								c.snapAmount[0] :
								c.snapAmount;
						...
						case 'x':
							var x = e('#mCSB_' + s.idx + '_dragger_horizontal'),
								...
								T =
										...
										y > 0 ? y / s.scrollRatio.x :
										0,
								k =

										B > 0 ? B / s.scrollRatio.x :
										0;
							break;
						case 'y':
							var x = e('#mCSB_' + s.idx + '_dragger_vertical'),
								...
								T =
										...
										y > 0 ? y / s.scrollRatio.y :
										0,
								k =

										B > 0 ? B / s.scrollRatio.y :
										0;
					}
			...
			J = function(e, t, o, a, n, i, r) {
				...
				function d() {
					null != S.id &&
						(
							window.requestAnimationFrame ? window.cancelAnimationFrame(S.id) :
							clearTimeout(S.id),
						(S.id = null));
				}
		...
		(e.fn[o] = function(t) {
			return
				u[t] ? u[t].apply(this, Array.prototype.slice.call(arguments, 1)) :
				'object' != typeof t && t ? void e.error('Method ' + t + ' does not exist') :
